    ...
    <main className="pt-20 md:pt-24 px-container-margin max-w-6xl mx-auto pb-24">
      ...
      {showAddProductModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md overflow-y-auto">
          <div className="bg-surface rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-surface-variant max-h-[85vh] overflow-y-auto my-auto animate-fadeIn mt-16 md:mt-20">
            <div className="flex items-center justify-between mb-4">
      ...
      {showEditShopModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center p-4 z-[100] overflow-y-auto animate-fadeIn">
          <div className="bg-surface-container-lowest p-6 md:p-8 rounded-2xl border border-surface-variant shadow-2xl max-w-xl w-full max-h-[85vh] overflow-y-auto my-auto mt-16 md:mt-20">
            <div className="flex items-center justify-between mb-4">
              <div>
